...
int main( int argc, const char** argv )
{
    ...
    cout << "Face data:" << face_cascade_name << endl;
    cout << "Eye data:" << eyes_cascade_name << endl;
    ...
    {
        cout << "Loaded face cascade with no errors" << endl;
    }
    ...
    {
        cout << "Loaded eyes cascade with no errors" << endl;
    }
